...
----销售员信息
--insert into  SalesPerson(SalePersonId,SalePersonName,LoginPwd) values('1007053309','王丽丽','123456')
--insert into  SalesPerson(SalePersonId,SalePersonName,LoginPwd) values('1007053310','王小刚','123456')
--insert into  SalesPerson(SalePersonId,SalePersonName,LoginPwd) values('1007053311','王大力','123456')
--超市会员信息
--insert into SMMembers(MemberId,MemberName,Points,PhoneNumber,MemberAddress,OpenTime,MemberStatus)
--values('1008695895','王晓敏',default,'13590856789','天津南开区',default,default)
...
select * from SalesListDetail

insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (1007046946,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (1008575734,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003001,500,100,500,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003002,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003003,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003004,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003005,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003006,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003007,1000,100,1000,1)
insert into ProductInventory( ProductId, TotalCount, MinCount, MaxCount, StatusId) values (6005004003008,1000,100,1000,1)